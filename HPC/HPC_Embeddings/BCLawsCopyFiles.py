        ...
        for letter_dir in os.listdir(source_dir):
            ...
            for doc_dir in os.listdir(letter_path):
                ...
                for file_name in os.listdir(doc_path):
                    ...
                    # Only look for XML files that are not parts or divisions
                    if file_path.lower().endswith('.xml') and not any(x in file_name.lower() for x in ['part_', 'division_', 'historical', 'legislative', 'table_of_contents']):
