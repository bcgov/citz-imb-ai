...
from app.mcp_agents.explicit_search import explicit_search_mcp
...
# agents_mcp.mount(community_detection_mcp, prefix="communitydetection") # Disabled for now
agents_mcp.mount(explicit_search_mcp, prefix="explicitsearch")
